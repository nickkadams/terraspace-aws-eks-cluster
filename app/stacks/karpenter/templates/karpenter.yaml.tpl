...
metadata:
  ...
  labels:
    helm.sh/chart: karpenter-v0.34.1
...
metadata:
  ...
  labels:
    ...
    app.kubernetes.io/managed-by: Helm
  annotations:
    eks.amazonaws.com/role-arn: arn:${arn_partition}:iam::${account_id}:role/KarpenterController-${cluster_name}
---
    ...
    spec:
      ...
      containers:
        - name: controller
          ...
          image: public.ecr.aws/karpenter/controller:v0.34.1@sha256:94f036df166a84658a67d2e0b9db73e2b3784fe3b40be89e37f5f9cd06cfe3c4
